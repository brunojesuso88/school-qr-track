...
const MATRIX_IRA = buildMatrixIraWeightIndex([
  { id: 'pt', series: '1', slot_index: 1, ira_weight: 4, name: 'LINGUA PORTUGUESA', aliases: ['Língua Portuguesa', 'Português'] },
  { id: 'let', series: '1', slot_index: 2, ira_weight: 1, name: 'LETRAMENTO EM LINGUA PORTUGUESA', aliases: [] },
  { id: 'ef', series: '1', slot_index: 3, ira_weight: 1, name: 'EDUCACAO FISICA', aliases: ['Educação Física'] },
]);
...
describe('carga semanal oficial da matriz como fonte de verdade', () => {
  ...
  it('sem a matriz, Português e Letramento ficam sem peso (bug original)', () => {
    const area = computeAreaIra(joaoData({ matrixWeeklyByKey: {}, matrixIraWeights: emptyIraWeightIndex() }), 'joao', getMedalArea('linguagens')!);
